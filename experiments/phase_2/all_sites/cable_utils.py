...
def set_site_info(met_fname, site, height, elev, tree_frac,
    ...
    urban_frac = 1.0 - tree_frac - grass_frac - bare_frac - water_frac

    patch[:] = 5
    iveg[:] = np.array([2,6,14,15,16]).reshape(5, 1, 1) # tree,grass,bare,urban,water
    patchfrac[:] = np.array([tree_frac,grass_frac,bare_frac,urban_frac,water_frac]).reshape(5, 1, 1) # tree,grass,bare,urban,water
